...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cloudflare-text-imge)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cloudflare-text-imge
```

A live public deployment of this template is available at [https://cloudflare-text-imge.templates.workers.dev](https://cloudflare-text-imge.templates.workers.dev)
